...
Du bewertest die Konfigurationen with_skill, without_skill desselben Prueffalls. Du weisst nicht, welche Konfiguration welche Anleitung hatte; bewerte nur die Ausgaben in `<konfiguration>/run-1/outputs/`.
