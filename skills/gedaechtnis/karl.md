...
| 2026-09-12 | **Tippentscheidungen heißt antippen, nicht abtippen** („ich muss nicht die Frage kopieren, sondern tippe sie an"). Meine erste Lesart — Optionen `a`/`b`/`c` im Text — war falsch und hat einen halben Tag gekostet. In Claude Code ist es die Frage mit anklickbaren Optionen; im Telegram-Bot fehlen Knöpfe (`reply_markup`), die Regel ist dort bis dahin **nicht** erfüllt. | Chat 2026-09-12 |
