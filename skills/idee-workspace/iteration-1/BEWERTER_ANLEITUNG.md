...
Du bewertest die Konfigurationen fassung-gericht, fassung-sparring, fassung-synthese, without_skill desselben Prueffalls. Du weisst nicht, welche Konfiguration welche Anleitung hatte; bewerte nur die Ausgaben in `<konfiguration>/run-1/outputs/`.
