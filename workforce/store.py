...
class Store:
    ...
    def set_setting(self, key: str, value: str) -> None:
        self._set_setting_sql(key, value)

    def _set_setting_sql(self, key: str, value: str) -> None:
    ...
    def audit_and_set(self, actor: str, request_id: str, kind: str, record_key: str, payload: Dict[str, Any],
        ...
        """One transaction for a row and the mark that says it was written (G-113): a crash
        between them would otherwise repeat the row under the same request-id next round."""
        with self._db:
